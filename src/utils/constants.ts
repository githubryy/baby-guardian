...
/** 家庭成员身份配置 */
export const FAMILY_RELATION_CONFIG: Record<
  FamilyRelation,
  {
    name: string;
    shortName: string;
...
/** 家庭身份选项（用于选择器） */
export const FAMILY_RELATION_OPTIONS = Object.entries(
...
/** 事项类型选项 (用于选择器) */
export const TASK_TYPE_OPTIONS = Object.entries(TASK_TYPE_CONFIG).map(
  ([value, config]) => ({
